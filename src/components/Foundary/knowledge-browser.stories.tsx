...
const meta: Meta<typeof KnowledgeBrowser> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A hierarchical knowledge browser component that allows users to explore and view documents organized in a tree structure with search functionality. Uses DocumentPreview and DocumentEdit components for document display and editing.',
      },
    },
  },
  tags: ['autodocs'],
...
export const WithSelectedDocument: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Knowledge browser with a pre-selected document to demonstrate the preview functionality.',
      },
    },
  },
}
...
export const DeepHierarchy: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Knowledge browser with deep hierarchical grouping (3 levels) to test nested navigation.',
      },
    },
  },
}
...
export const WithEditMode: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Knowledge browser with editable documents. Click the Edit button to modify document content.',
      },
    },
  },
}
