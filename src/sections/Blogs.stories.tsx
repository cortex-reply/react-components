...
import { ImageTest } from '../tests/payload'
...
const sampleBlogs = [
  ...
  {
    title: 'NEWS',
    content: 'Business Outcomes of an AI Centre of Excellence',
    link: { label: 'LEARN MORE', url: '#' },
    image: ImageTest.hero,
    name: '2',
  },
  {
    title: 'INSIGHT',
    content: 'AI & Business: The Next Big Thing in Tech',
    link: { label: 'LEARN MORE', url: '#' },
    image: ImageTest.hero,
    name: '3',
  },
